...
export const getMenuById = category_id => fetch('/user/updateUser' + category_id);

/**
 * 更新食品信息
 */

export const updateFood = data => fetch('/user/updateUser', data, 'POST');
// 添加用户列表数据

export const addUser = data => fetch('/user/addUser', data, 'POST');

// 导入
export const importIn = data => fetch('/user/importIn', data, 'POST')

/**
 * 删除食品
 */

export const deleteFood = data => fetch('/user/deleteUser', data, 'POST');
